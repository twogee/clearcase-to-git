    ...
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    using (var gitWriter = new GitWriter(importerArguments.ClearcaseRoot, importerArguments.TrimRoots, importerArguments.NoFileContent, importerArguments.Labels, importerArguments.Prefixes, importerArguments.Roots))
                    {
                ...
                if (!importerArguments.GenerateVobDBOnly)
                {
                    ...
                    using (var gitWriter = new GitWriter(importerArguments.ClearcaseRoot, importerArguments.TrimRoots, importerArguments.NoFileContent, importerArguments.Labels, importerArguments.Prefixes, importerArguments.Roots, branchRename))
                    {
